        ...
        <div className="flex flex-col flex-1 bg-[#F9FAFC]">
          ...
          <div className="flex flex-col overflow-y-scroll">
            <div className="flex flex-1 justify-center items-center">
              <div className="flex flex-col h-[300px] w-[500px] justify-start items-center border-2 shadow-md rounded-md  bg-white m-4">
                <div className="flex flex-row w-full h-[50px] justify-between">
                  <div className="flex h-fit w-fit m-4 p-2 bg-[#665DD9] rounded-md">
                    <svg
                      width="22"
                      height="21"
                      viewBox="0 0 22 21"
              ...
              <div className="flex flex-col h-[300px] w-[500px] justify-start items-center border-2 shadow-md rounded-md  bg-white m-4">
                <div className="flex flex-row w-full h-[50px] justify-between">
                  <div className="flex flex-1 justify-center items-center mt-4 flex-row gap-1">
                  ...
                  <div className="flex flex-1 mr-2 justify-end items-center">
                    <div className="flex flex-row justify-center items-center gap-2">
                      <div className="flex font-semibold">date</div>
            ...
            <div className="flex flex-1 justify-center items-center">
              <div className="flex flex-col h-[300px] w-[500px] justify-start items-center border-2 shadow-md rounded-md  bg-white m-4">
                <div className="flex flex-row w-full h-[50px] justify-between">
                  ...
                  <div className="flex flex-1 mr-2 justify-end items-center"></div>
                </div>
                <div className="flex flex-1 mr-2 justify-end items-center">
                  qweqd
                </div>
